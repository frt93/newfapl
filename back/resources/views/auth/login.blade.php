                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('signin') }}">
                            ...
                            <div class="form-group{{ $errors->has('exceeded') ? ' has-error' : '' }}">
                                <div class="col-md-8 col-md-offset-4">
                                    @if ($errors->has('exceeded'))
                                        <span class="help-block">
                                        <strong>{{ $errors->first('exceeded') }} {{ $errors->first('time') }} {{ $errors->first('seconds') }}</strong>
                                    </span>
                                    @endif
                                    ...
                                    <p><a href="{!! route('socialite.auth', 'vkontakte') !!}">VK</a></p>
                                    <p><a href="{!! route('socialite.auth', 'yandex') !!}">Yandex</a></p>
